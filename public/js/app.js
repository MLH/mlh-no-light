...
(function() {
  ...
  NoLight.init = function() {
    var chars_count, editor, header, lines_count, screen_height, screen_width, submission_html, submission_name, submit_button;
    header = $('header');
    editor = $('#editor');
    ...
    editor.submit(function(e) {
      ...
      return NoLight.confirmAndPrompt().then(function(name) {
  ...
  NoLight.confirmAndPrompt = function() {
    return new Promise(function(resolve, reject) {
      var confirm_dialog, name_prompt;
